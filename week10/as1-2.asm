...
jal TRACK # Danh dau dia diem hien tai de bat dau ve canh 1
addi $a0, $0, 150 # Quay goc 150 
jal ROTATE
jal GO
sleep1:
addi $v0, $zero, 32 # De no chay trong 3000ms
...
jal TRACK # Danh dau TRACK de bat dau ve canh 2
addi $a0, $0, 30 # Quay goc 30
jal ROTATE
jal GO
sleep2:
addi $v0, $zero, 32 # De no chay trong 2990ms
li $a0, 2950	# cho bot chay gan den goc do thi dung
syscall
jal UNTRACK # Ve duong thang tu diem hien tai toi TRACK cu
